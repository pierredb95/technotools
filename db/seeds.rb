...
Track.create(name: 'Come Together',                           vinyl: abbeyroad)
Track.create(name: 'Something',                               vinyl: abbeyroad)
Track.create(name: 'Maxwell\'s Silver Hammer',                vinyl: abbeyroad)
Track.create(name: 'Oh! Darling',                             vinyl: abbeyroad)
Track.create(name: 'Octopus\'s Garden',                       vinyl: abbeyroad)
Track.create(name: 'I Want You (She\'s So Heavy)',            vinyl: abbeyroad)
Track.create(name: 'Here Comes the Sun',                      vinyl: abbeyroad)
Track.create(name: 'Because',                                 vinyl: abbeyroad)
Track.create(name: 'You Never Give Me Your Money',            vinyl: abbeyroad)
Track.create(name: 'Sun King',                                vinyl: abbeyroad)
Track.create(name: 'Mean Mr. Mustard',                        vinyl: abbeyroad)
Track.create(name: 'Polythene Pam',                           vinyl: abbeyroad)
Track.create(name: 'She Came In Through the Bathroom Window', vinyl: abbeyroad)
Track.create(name: 'Golden Slumbers',                         vinyl: abbeyroad)
Track.create(name: 'Carry That Weight',                       vinyl: abbeyroad)
Track.create(name: 'The End',                                 vinyl: abbeyroad)
Track.create(name: 'Her Majesty ',                            vinyl: abbeyroad)
